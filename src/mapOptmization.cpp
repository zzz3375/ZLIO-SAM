...
#include "lio_sam_mid360_pointcloud2/save_map.h"
...
public:
    ...
    mapOptimization()
    {
        ...
        subCloud = nh.subscribe<lio_sam_mid360_pointcloud2::cloud_info>("lio_sam/feature/cloud_info", 1, &mapOptimization::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());
        ...
        pubSLAMInfo           = nh.advertise<lio_sam_mid360_pointcloud2::cloud_info>("lio_sam/mapping/slam_info", 1);
    ...
    void laserCloudInfoHandler(const lio_sam_mid360_pointcloud2::cloud_infoConstPtr& msgIn)
    {
        // extract time stamp
    ...
    bool saveMapService(lio_sam_mid360_pointcloud2::save_mapRequest& req, lio_sam_mid360_pointcloud2::save_mapResponse& res)
    {
    ...
    void visualizeGlobalMapThread()
    {
        ...
        lio_sam_mid360_pointcloud2::save_mapRequest  req;
        lio_sam_mid360_pointcloud2::save_mapResponse res;
    ...
    void publishFrames()
    {
        ...
        if (pubSLAMInfo.getNumSubscribers() != 0)
        {
            ...
            {
                lio_sam_mid360_pointcloud2::cloud_info slamInfo;
