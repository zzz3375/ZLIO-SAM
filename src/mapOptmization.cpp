...
public:
    ...
    mapOptimization()
    {
        ...
        subCloud = nh.subscribe<zlio_sam::cloud_info>("lio_sam/feature/cloud_info", 1, &mapOptimization::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());
        ...
        pubSLAMInfo           = nh.advertise<zlio_sam::cloud_info>("lio_sam/mapping/slam_info", 1);
    ...
    void laserCloudInfoHandler(const zlio_sam::cloud_infoConstPtr& msgIn)
    {
        // extract time stamp
    ...
    bool saveMapService(zlio_sam::save_mapRequest& req, zlio_sam::save_mapResponse& res)
    {
    ...
    void visualizeGlobalMapThread()
    {
        ...
        zlio_sam::save_mapRequest  req;
        zlio_sam::save_mapResponse res;
